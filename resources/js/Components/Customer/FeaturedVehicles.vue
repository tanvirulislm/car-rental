        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Choose from our premium selection of vehicles for every
                    occasion
                </p>
            </div>
            ...
            <div class="text-center mt-10">
                <Link
                    href="/all-cars"
                    class="inline-flex items-center border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-4 py-2 rounded text-sm font-semibold transition-all"
                >
